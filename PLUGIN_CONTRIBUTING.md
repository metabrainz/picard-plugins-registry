...
> [!NOTE]
> You would usually not clone the repository directly into Picard's plugin install directory. Instead, clone it into a separate development directory and install the plugin as described below.
